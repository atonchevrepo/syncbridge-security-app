                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <button
                            ...
                            className={`flex items-center w-full px-4 py-2 rounded-lg text-left transition duration-150 ease-in-out ${activeModule === 'innovative-designs' && allowedModules.includes('innovative-designs') ? 'bg-indigo-700 text-white' : 'hover:bg-gray-700 text-gray-300'} ${!allowedModules.includes('innovative-designs') ? 'opacity-50 cursor-not-allowed' : ''}`}
                            disabled={!allowedModules.includes('innovative-designs')}
                        >
